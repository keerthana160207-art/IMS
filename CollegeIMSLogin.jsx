...
export default function CollegeIMSLogin() {
  ...
  const handleSubmit = () => {
    alert(`Signing in as ${role}: ${userId}`);
  };
...
const styles = {
  ...
  logoBox: {
    ...
    height: 48,
    borderRadius: 10,
    background: "linear-gradient(135deg, #1a9e8f, #0e6e9e)",
    display: "flex",
    alignItems: "center",
    justifyContent: "center",
  },
  ...
  signInBtn: {
    ...
    borderRadius: 8,
    border: "none",
    background: "linear-gradient(135deg, #1a9e8f, #17b897)",
    color: "#fff",
    fontSize: 15,
    fontWeight: 600,
    cursor: "pointer",
